<style>
	...
	.ewm_llt_save_location_group_lcl{
			...
			<div class="ewm_llt_subbody_main_lcl">
				<div class="ewm_llt_locations_list_lcl">
						...
						<div class="ewm_llt_locations_single_lcl">
							...
							<div  class="ewm_llt_locations_single_item_lcl">
								<center>
									<input type="button" class="ewm_llt_save_location_group_lcl" value="Save Location Group">
									<span class="ewm_llt_message_save_success"></span>
								</center>
							</div>
						</div>
...
$group_upgrade_llt = LLT_HOME_DIR . '/templates/admin/mainllt/single/popup/upgrade/group_upgrade_llt.php';
